...
const ViewProductAdmin = () => {
  ...
  useEffect(() => {
    ...
    if (productDetails.price) {
      setRetail_Price(productDetails.price.Retail_Price || '');
              ...
              <>
                <ProductContainer>
                  ...
                  <ProductInfo>
                    ...
                    <PriceContainer>
                      <PriceCost>R{productDetails && productDetails.price && productDetails.price.cost}</PriceCost>
                      <PriceRetail_Price>R{productDetails && productDetails.price && productDetails.price.Retail_Price}</PriceRetail_Price>
                        ...
                        <form onSubmit={submitHandler}>
                          <Stack spacing={3}>
                            ...
                            <TextField
                              ...
                              label="Retail_Price"
                              value={Retail_Price}
                              onChange={(event) => setRetail_Price(event.target.value)}
                              required
                              InputLabelProps={{
                                shrink: true,
                              }}
