...
const Home = () => {
  const adURL =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAaa7D_bvwy0U_Zq8gjrrz4dWKC6VibrKGOQ&s';
      ...
      {showNetworkError ? (
        ...
        <>
          {responseProducts ? (
            <>
               <StyledContainer>
    <p>No Product found right now</p>
    <p>Become an Admin to add products</p>
    <StyledLink to={"/Adminregister"}>Join</StyledLink>
  </StyledContainer>
            </>
          ) : (
            <>
...
const StyledLink = styled(Link)`
  color: #fff; // Primary color for the link
  font-weight: bold;
...
border-radius: 5px;
  ...
  &:hover {
    color: #7f56da; // Darker color on hover
