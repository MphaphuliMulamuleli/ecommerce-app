...
const Cart = ({ setIsCartOpen }) => {
    ...
    const totalOGPrice = cartDetails.reduce((total, item) => total + (item.quantity * item.price.cost), 0);
            ...
            {cartDetails.length === 0 ? (
                ...
                <CardGrid container spacing={2}>
                        ...
                        >
                            <CartItem>
                                ...
                                <ProductDetails>
                                    ...
                                    <Typography variant="subtitle2">
                                        Final Price: R{data.price.cost}
                                    </Typography>
                                    <Typography variant="subtitle2">
                                        Quantity: {data.quantity}
                                    </Typography>
                                    <Typography variant="subtitle2">
                                        Total: R{data.quantity * data.price.cost}
                                    </Typography>
                                    <ButtonContainer>
                                        <Button
                                            variant="outlined"
                    ...
                    <StyledPaper ref={priceContainerRef}>
                        ...
                        <Divider sx={{ my: 1 }} />
                        <DetailsContainer>
                            Price ({totalQuantity} items) = R{totalOGPrice}
                            <br /><br />
                            Discount = R{totalOGPrice - totalNewPrice}
                            <Divider sx={{ my: 1 }} />
                            Total Amount = R{totalNewPrice}
                        </DetailsContainer>
